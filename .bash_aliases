...
# App MyTRELORA.com
alias run-gpigs-core="docker run -ti -p 127.0.0.1:3000:3000 -p 127.0.0.1:3001:3001 --name gpigs-core --link mysql:mysql -v ~/Projects/gpigs-core:/Projects/gpigs-core --env-file <(env | grep TRELORA) -e PORT=3000 -e RAILS_ENV=development -d docker-registry.trelora.com:443/development/gpigs-core:ian"
alias run-gpigs-core-debug="docker run -ti -p 127.0.0.1:3000:3000 -p 127.0.0.1:3001:3001 --name gpigs-core --link mysql:mysql -v ~/Projects/gpigs-core:/Projects/gpigs-core --env-file <(env | grep TRELORA) -e PORT=3000 -e RAILS_ENV=development docker-registry.trelora.com:443/development/gpigs-core:ian"
alias gpigs-core-console="docker exec -it gpigs-core bash"
alias rebuild-gpigs-core="docker build -t docker-registry.trelora.com:443/development/gpigs-core:ian ."

# Box API
alias run-box-api="docker run -ti -p 5000:5000 --name box-api --link redis:redis -v ~/Projects/box-api:/Projects/box-api --env-file <(env | grep BOX_API) -e PORT=5000 -e RACK_ENV=development -d docker-registry.trelora.com:443/development/box-api:ian"
alias box-api-console="docker exec -it box-api bash"
alias rebuild-box-api="docker build -t docker-registry.trelora.com:443/development/box-api:ian ."
...
run_in_docker() {
  ...
  if [ "${path:26:100}" = "gpigs-core" ] ; then
    docker run -it --rm --link mysql:mysql -v $path:${path:16:100} --env-file <(env | grep TRELORA) docker-registry.trelora.com:443/development/gpigs-core:ian $@
  else
    if [ "${path:26:100}" = "stubbery" ] ; then
      ...
      if [ "${path:26:100}" = "box-api" ] ; then
        docker run -it --rm --link redis:redis -v $path:${path:16:100} --env-file <(env | grep BOX_API) docker-registry.trelora.com:443/development/box-api:ian $@
      else
