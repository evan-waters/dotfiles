...
# App MyTRELORA.com
alias run-gpigs-core="docker run -ti -p 127.0.0.1:3000:3000 -p 127.0.0.1:3001:3001 --name gpigs-core --link trelora-mysql:mysql -v ~/Projects/gpigs-core:/Projects/gpigs-core --env-file <(env | grep TRELORA) -e PORT=3000 -e RAILS_ENV=development -d docker-registry.trelora.com:443/trelora/gpigs-core"
alias run-gpigs-core-debug="docker run -ti -p 127.0.0.1:3000:3000 -p 127.0.0.1:3001:3001 --name gpigs-core --link trelora-mysql:mysql -v ~/Projects/gpigs-core:/Projects/gpigs-core --env-file <(env | grep TRELORA) -e PORT=3000 -e RAILS_ENV=development docker-registry.trelora.com:443/trelora/gpigs-core"
...
run_in_docker() {
  ...
  if [ "${path:26:100}" = "gpigs-core" ] ; then
    docker run -it --rm --link trelora-mysql:mysql -v $path:${path:16:100} --env-file <(env | grep TRELORA) docker-registry.trelora.com:443/trelora/gpigs-core $@
  else
